...
class DataDefine(models.Model):
    ...
    name = models.CharField('数据名称', max_length=64, help_text='数据名称')
...
class FormFields(models.Model):
    ...
    col_title = models.CharField('字段名称', max_length=20, help_text='字段名称')
    col_name = models.CharField('数据库字段名', max_length=16, help_text='数据库字段名')
